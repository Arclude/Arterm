...
import { getName, getVersion } from "@/platform/app";
import { openUrl } from "@/platform/opener";
import { arch, platform } from "@/platform/os";
import { useEffect, useState } from "react";
import { SectionHeader } from "../components/SectionHeader";

const REPO_URL = "https://github.com/Arclude/Arterm";
const WEBSITE = "https://arterm.dev";
...
export function AboutSection() {
  ...
  const [name, setName] = useState("Arterm");
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <dl className="grid grid-cols-[110px_1fr] gap-y-2.5 text-[12px]">
        ...
        <dd className="font-mono text-[11.5px]">app.arclude.arterm</dd>
