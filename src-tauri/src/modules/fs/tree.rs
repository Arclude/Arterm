...
pub fn fs_read_dir(
    ...
    fs_read_dir_inner(path, show_hidden, workspace, &registry)
}
...
pub fn fs_read_dir_inner(
    ...
    let root = authorize_fs_path(registry, &path, &workspace)?;
...
pub fn list_subdirs(
    ...
    list_subdirs_inner(path, show_hidden, workspace, &registry)
}
